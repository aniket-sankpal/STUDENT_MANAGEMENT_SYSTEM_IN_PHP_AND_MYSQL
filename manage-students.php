...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="card-body" style="background-color:#c5c9d1">
                    ...
                    <div class="table-responsive border rounded p-1">
					 ...
					 <th class="font-weight-bold" style="color:#fafbfc"><h5>S.No</h5></th>
					  ...
					  <th class="font-weight-bold" style="color:#fafbfc"><h5>Student Email</h5></th>
					    <th class="font-weight-bold" style="color:#fafbfc"><h5>Admission Date</h5></th>
					   <th class="font-weight-bold" style="color:#fafbfc"><h5>Batch Time</h5></th>
					  <th></th>
					  <th></th>
						 <th class="font-weight-bold" style="color:#fafbfc"><h5>Fees</th>
						  <th></th>
						 	<th class="font-weight-bold" style="color:#fafbfc"><h5>Total Fees</h5></th>
    ...
    <th></th>
							...
							<th class="font-weight-bold" style="color:#fafbfc"></th>
							<th class="font-weight-bold" style="color:#fafbfc"></th>
                            <th class="font-weight-bold"></th>
...
{               ?>   
                          <tr>
                            ...
                            <td><h4><?php  echo htmlentities($row->ClassName);?> <?php  echo htmlentities($row->Section);?></h4></td>
                            <td><h4><?php  echo htmlentities($row->StudentName);?></h4></td>
                            <td><h4><?php  echo htmlentities($row->StudentEmail);?></h4></td>
							
                            <td><h4><?php  echo htmlentities($row->DateofAdmission);?></h4></td>
                            <td><h4><?php  echo htmlentities($row->BatchTime);?></h4></td> 
							  <td></td>
							...
							<td>
							<h4><?php  echo $t=$row->FirstInstall+$row->secondInstall+$row->thirdInstall;?></h4>
                            </td>
