<?php
 $hName='localhost'; // host name
    ...
    $dbName = "studentmsdb"; // database name
    ...
    if (isset($_POST['signup'])) {
        ...
        if (!$error) {
            if(mysqli_query($conn, "INSERT INTO tbladmin(AdminName, UserName, MobileNumber, Email, Password) VALUES('" . $username . "','" . $username . "', '" . $mobile . "', '" . $email . "', '" . md5($password) . "')")) {
