  ...
  <body>
    <div class="container-scroller">
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth " style="background-color:#cadee8">
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto ">
			  
					<h1 style="color:#187ef2">SURABHI COMPUTERS</h1>
              <div class="auth-form-light text-left p-5 "style="background-color:">
