        ...
        <!-- partial -->
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Manage Students Fees </h3>
                ...
                <div class="card">
                  <div class="card-body" style="background-color:#c5c9d1">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Students Fees</h4>
...
{               ?>   
                          <tr>
                            ...
                            <td><h5><?php echo htmlentities($cnt);?></h5></td>
                            <td><h5><?php  echo htmlentities($row->StuID);?></h5></td>
                            <td><h5><?php  echo htmlentities($row->ClassName);?> <?php  echo htmlentities($row->Section);?></b></h5></td>
                            <td><h5><?php  echo htmlentities($row->StudentName);?></h5></td>
                            <!-- <td><?php  echo htmlentities($row->StudentEmail);?></h5></td> -->
							
                            <!-- <td><?php  echo htmlentities($row->DateofAdmission);?></b></h5></td> -->
                            <!--  <td><?php  echo htmlentities($row->BatchTime);?></td> -->
							  <td></td>
							<td><h5><?php  echo htmlentities($row->FirstInstall);?></h5></td>
                           
                            <td><h5><?php  echo htmlentities($row->secondInstall);?></h5>
							<td><h5><?php  echo htmlentities($row->thirdInstall);?></h5>
							
                            </td>
							<td><h5>
							<?php  echo $t=$row->FirstInstall+$row->secondInstall+$row->thirdInstall;?></h5>
                            </td>
