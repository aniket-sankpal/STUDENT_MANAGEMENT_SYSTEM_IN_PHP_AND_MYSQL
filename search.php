...
$sdata=$_POST['searchdata'];
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
                    ...
                    <div class="table-responsive border rounded p-1">
					 ...
					 <th class="font-weight-bold">S.No</th>
					  ...
					  <th class="font-weight-bold">Student Email</th>
					   ...
					   <th class="font-weight-bold">Batch Time</th>
					  <th class="font-weight-bold">Date OF Birth</th>
					  <th></th>
						 <th class="font-weight-bold">Fees</th>
						  <th></th>
						 	<th class="font-weight-bold">Total Fees</th>
							<th class="font-weight-bold">Fees Status</th>
    ...
    <th></th>
							...
							<th class="font-weight-bold">I st installation</th>
							<th class="font-weight-bold">II nd installation</th>
							<th class="font-weight-bold">III rd installation</th> 
							<th class="font-weight-bold"></th>
							<th class="font-weight-bold"></th>
                            <th class="font-weight-bold"></th>
...
{               ?>   <tr>
							...
							<td><?php  echo htmlentities($row->FirstInstall);?></td>
                           
                            <td><?php  echo htmlentities($row->secondInstall);?>
							<td><?php  echo htmlentities($row->thirdInstall);?>
							
                            </td>
							<td>
							<?php  echo $t=$row->FirstInstall+$row->secondInstall+$row->thirdInstall;?>
                            </td>
