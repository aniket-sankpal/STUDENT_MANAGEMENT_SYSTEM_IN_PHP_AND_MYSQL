                    ...
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        <thead style="background-color:#37465e">
                          <tr>
                            <th class="font-weight-bold" style="color:#fafbfc">S.No</th>
                            <th class="font-weight-bold" style="color:#fafbfc">Course Name</th>
                            <th class="font-weight-bold" style="color:#fafbfc">Courcse code</th>
                            <th class="font-weight-bold" style="color:#fafbfc">Creation Date</th>
                            <th class="font-weight-bold" style="color:#fafbfc">Action</th>
