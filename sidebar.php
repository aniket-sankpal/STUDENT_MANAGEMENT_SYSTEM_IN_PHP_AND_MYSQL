...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-class.php">Add Courses</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-class.php">Manage Courses</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
				  ...
				  <li class="nav-item"> <a class="nav-link" href="all-students.php">View all Students</a></li>
           ...
           <!-- <li class="nav-item">
			...
			<!--  <li class="nav-item">
              <a class="nav-link" href="bday.php">
                <span class="menu-title">Todays Bday</span>
                <i class=""></i>
              </a>
            </li>
			-->
  ...
  <li class="nav-item">
              <a class="nav-link" href="att/date_view.php">
