...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $ti=$_POST['ti'];
 $time=$_POST['btime'];
$sql="update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address,FirstInstall=:fi,secondInstall=:si,thirdInstall=:ti where ID=:eid";
...
<div class="form-group">
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
                        <label for="exampleInputName1">Batch Timing</label>
                        <input type="time" name="btime" value="<?php  echo htmlentities($row->BatchTime);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
 ...
 <?php } ?> 
                      ...
                      <div class="form-group">
                        ...
                        <img src="images/<?php echo $row->Image;?>" width="100" height="100" value="<?php  echo $row->Image;?>"><a href="changeimage.php?editid=<?php echo $row->ID;?>"> &nbsp; Edit Image</a>
					                        ...
					                        <div class="form-group">
                        <label for="exampleInputName1">Student Signature</label>
                        <img src="images/<?php echo $row->Sign;?>" width="100" height="100" value="<?php  echo $row->Sign;?>"><a href="changeimage.php?editid=<?php echo $row->ID;?>"> &nbsp; Edit Signature Image</a>
                      </div>
...
<!--<div class="form-group">-->
					  ...
					  <div class="form-group">
                        <label for="exampleInputName1">First Installation</label>
                        <input type="text" name="fi" class="form-control" required='true' value="<?php  echo htmlentities($row->FirstInstall);?>" >
                      </div>
					   
					  <div class="form-group">
                        <label for="exampleInputName1">Second Installation</label>
                        <input type="text" name="si" class="form-control" value="<?php  echo htmlentities($row->secondInstall);?>">
                      </div>
					   
					  <div class="form-group">
                        <label for="exampleInputName1">Third Installation</label>
                        <input type="text" name="ti" class="form-control" value="<?php  echo htmlentities($row->thirdInstall);?>">
                      </div>
