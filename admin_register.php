...
$sql="insert into  register_admin (Username, MobileNumber, Email, Password) values (:username, :mobilenumber, :email, :password)";
...
<body>
<form id="form" method="post" onsubmit="return validation();" class="form" action="adminloading.php">
<div class="container"> 
   
<center> <h1 class="sr">Admin Registration</h1></center>
...
<input type="submit" onclick="window.location.href='admin/login.php'" value="I Have My Login" class="logbtn"    />

 </form>
 <Button onclick="window.location.href='login.php'" class="homebtn">Home</Button>
</div>  
</body>
</html>
