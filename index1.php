...
<div class="banner" style="background-image: url('images/fb.jpg');background-repeat: no-repeat;">
<!--<div style="background-image: url('images/fb.jpg');background-repeat: no-repeat;"> -->
  <div class="container">
...
<div class="slider">
       <div class="callbacks_container">
        <ul class="rslides" id="slider">
         <li>     
        <h1  style="color:#141414;-webkit-text-stroke-width: 1px;


-webkit-text-stroke-color: #fff;font-size:60px; " ><b>Student Managment System</b></h1> 


          <p style="color:#141414"font-size:40px;;>Admin Login ></p>   


          <div class="readmore">
         <a href="admin/login.php">Admin Login &nbsp</a>
          </div>
         </li>
